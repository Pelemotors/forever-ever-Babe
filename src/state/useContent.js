...
const contentData = {
  ...
  "stories": [
    ...
    {
      "id": "my-wife-is-my-strength",
      "title": "אישתי היא הכוח שלי",
      "status": "public",
      "unlockAt": null,
      "body": [
        "תמיד היית הכוח שלי , המעודדת שלי, גם כשהיינו רק חברים . תמיד גיבית אותי , תמיד איתגרת אותי ולא סתם ענית לי כן על הכל , תמיד פרגנת כשהיה רק פירור של פרגון לשחרר, ואף פעם לא הבנתי למה. אני עדיין לא מבין . כמה פעמים נתקענו עם האוטו, ועוד איפה תקעתי אותנו עם האוטו, כמה פעמים רדפתי אחרי דבורים עם מחבט חשמלי ביער כי הן הפריעו לי לעשן, כמה פעמים התנהגתי כמו לוזר- ואת נשארת שם מתנהגת כמו מעריצה מאוהבת .",
        "אני עדיין לא מבין למה ואיך, אני עדיין לא מעכל שאת אישתי, שהקמנו בית ומשפחה יחד, ושאנחנו באמת על הנתיב של \" באושר ועושר עד עצם היום הזה\" (בעירבון מוגבל עניין העושר כפי הנראה).",
        "את עושה אותי מאושר , אני יודע שלפעמים אני נשמע כאילו את לא, אבל אני תמיד מבין בדיעבד שאת הדבר הכי טוב בחיים שלי. תודה לך שאת מצליחה בכל פעם לשמור עלינו, ולשמור עליי אפילו מעצמי.",
        "יכול להיות שזה זה שאני מקפיד לחזור עם חלב הביתה ?",
        "לא נראה לי, הרי לא כל השנים היינו יחד .",
        "או שכן ולא הבנתי ?",
        "החברה הכי טובה שהייתה לי , עברנו כל כך הרבה רגשות ותחושות יחד, אינטימיות שאני בטח לא הכרתי ועדיין מתקשה להסביר.",
        "את האחת שלי.",
        "תודה לך על המשפחה שאת מלמדת אותנו להיות.",
        "אני מאחל לנו שלעוד הרבה שנים טובות הסיפור הזה יימשך ונכתוב בו יחד עוד פרקים רבים .",
        "אני אוהב אותך , ולא מצליח למצוא את המילים כדי להסביר עד כמה."
      ]
    }
  ],
  "addons": {
